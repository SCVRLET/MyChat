...
namespace MyChat.Migrations
{
    ...
    [Migration("20210308092601_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyChat.Models.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyChat.Models.ChatUser", b =>
                {
            ...
            modelBuilder.Entity("MyChat.Models.ChatUser", b =>
                {
                    b.HasOne("MyChat.Models.Chat", "Chat")
                        .WithMany()
            ...
            modelBuilder.Entity("MyChat.Models.Message", b =>
                {
                    b.HasOne("MyChat.Models.Chat", null)
                        .WithMany("Messages")
                        .HasForeignKey("ChatId");
                });
